...
export const Header = () => {
  ...
  // Active state checking based on location and search params
  const searchParams = new URLSearchParams(location.search);
  const isHomeActive = location.pathname === '/';
  const isGenreActive = location.pathname === '/search' && searchParams.has('genreIds');
  ...
  const isTopRatingActive = location.pathname === '/search' && searchParams.get('sortBy') === 'rating';
