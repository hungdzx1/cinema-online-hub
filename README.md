...
### 📐 Class Diagram — 12 Entity + RefreshToken
...
![Component Diagram](Component_Diagram_PhimHay24h.png)
...
### 🔄 Activity Diagram — Luồng nghiệp vụ

#### 🔐 Đăng nhập (Login)

![Đăng nhập](DangNhap.drawio.png)
...
![Quên mật khẩu](Forget_Password.png)

#### 🎬 Xem phim (Watch Movie)

![Xem phim](XemPhim.drawio.png)

---

### 📡 Sequence Diagram — Luồng xác thực JWT khi đăng nhập

![Sequence Diagram JWT](Screenshot%202026-07-27%20223532.png)
...
![Trang chủ Admin](Screenshot%202026-07-27%20224105.png)

#### 🌐 Trang chủ Web Phim — Phimplay24 trên Vercel

![Trang chủ Phim](Screenshot%202026-07-27%20224127.png)
